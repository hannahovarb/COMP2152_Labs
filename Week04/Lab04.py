...
test_moves = ["UD", "LL", "UDRL", "LDRRLRUULR"]
...
# Test cases
test_strings = ["leetcode", "loveleetcode", "aabb", "python", "aabbbc"]

for s in test_strings:
    index = first_unique_character(s)
    
    if index != -1:
        print(f"First unique character in '{s}': index {index} (character: '{s[index]}')")
    else:
        print(f"First unique character in '{s}': index -1 (no unique character)")
